...
import { useCategories, usePaginatedProducts, useBrands, useProducts } from "../hooks/useProducts";
...
export const CategoryPage: React.FC = () => {
    ...
    // 1. Fetch Categories to find current
    ...
    // 3. Fetch Brands for Category Brand-Counts (Fetch all category products)
    const { data: categoryProducts = [] } = useProducts(category ? { category_id: category.id, limit: 1000 } : {});
    const { data: allBrands = [] } = useBrands();

    // Derive brand counts based on products in this category
    ...
    React.useEffect(() => {
        setCurrentPage(1);
    }, [categorySlug, selectedBrand, sortBy, searchQuery]);
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 border-b border-white/10 pb-8 animate-fade-in-up">
                    <div className="max-w-2xl text-left">
                        ...
                        <p className="text-white/60 text-xs md:text-base font-light tracking-wide leading-relaxed">
                            {totalProducts} Items Available in this selection
                        </p>
                    </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] opacity-30">/ {categoryProducts.length}</span>
                                        </button>
