    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto h-full px-6 md:px-12 pt-32 pb-[120px] md:pb-12 flex flex-col md:flex-row">
          ...
          <div className={`w-full md:w-[32%] lg:w-[28%] h-full md:border-r border-white/5 md:pl-8 lg:pl-12 flex flex-col justify-start pt-32 md:pt-4 px-6 md:px-0 bg-black md:bg-transparent absolute md:relative top-0 left-0 transition-all duration-500 z-10 ${(activePanel === 'collections' || hoveredLink === 'collections') ? 'translate-x-0 opacity-100 pointer-events-auto flex' : 'md:opacity-0 md:translate-x-full opacity-0 translate-x-10 pointer-events-none hidden md:flex'
            }`}>
            <button
