          ...
          <div className="relative flex items-center gap-2 md:gap-3">
            ...
            >
              {images.map((img, idx) => (
                ...
                >
                  <img src={optimizedImageUrl(img, 'thumbnail')} alt="" loading="lazy" onError={(e) => { e.currentTarget.src = img; }} className="w-full h-full object-contain pointer-events-none" />
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-black/90 pb-6 pt-4">
            ...
            >
              {images.map((img, idx) => (
                ...
                >
                  <img src={optimizedImageUrl(img, 'thumbnail')} alt="" loading="lazy" onError={(e) => { e.currentTarget.src = img; }} className="w-full h-full object-cover" />
                </button>
              ))}
            </div>
          </div>
