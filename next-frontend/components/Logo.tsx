...
interface LogoProps {
  ...
  compact?: boolean; // Scroll-reactive compact mode
}
...
const BrandSymbol = ({ size = "normal" }: { size?: "normal" | "large" }) => (
  <svg
    ...
    className={`transition-all duration-500 overflow-visible ${
      size === 'large' ? 'w-32 h-32 md:w-48 md:h-48' : 'w-7 h-7 md:w-10 md:h-10'
    }`}
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
  ...
  >
    ...
    <path
      ...
      strokeWidth="1.5"
      strokeDasharray="40"
      className="animate-[draw-40_0.3s_ease-in-out_forwards]"
    />
    <path
      ...
      strokeWidth="1.5"
      strokeDasharray="40"
      className="animate-[draw-40_0.3s_ease-in-out_0.1s_forwards]"
    />
    <path
      ...
      strokeWidth="1.5"
      strokeDasharray="40"
      className="animate-[draw-40_0.3s_ease-in-out_0.2s_forwards]"
    />
    ...
    <circle
      ...
      stroke="url(#gold-grad)"
      fill="url(#gold-grad)"
      className="animate-[fadeIn_0.3s_ease-out_0.8s_forwards] opacity-0"
    />
    ...
    <path
      ...
      strokeWidth="2"
      strokeDasharray="100"
      className="animate-[draw-100_0.5s_ease-in-out_0.3s_forwards]"
      filter="url(#glow-symbol)"
    />
    ...
    <path
      ...
      strokeWidth="2.5"
      strokeDasharray="200"
      className="animate-[draw-200_0.6s_ease-in-out_0.4s_forwards]"
      filter="url(#glow-symbol)"
    />
    ...
    <path
      ...
      stroke="url(#gold-grad)"
      strokeWidth="1"
      className="animate-[fadeIn_0.2s_ease-in-out_0.9s_forwards] opacity-0"
      opacity="0.8"
    />
  </svg>
);

export const Logo: React.FC<LogoProps> = ({ className = "", variant = "default", compact = false }) => {
    ...
    return (
      <div className={`flex flex-col items-center justify-center ${className}`}>
        ...
        <div className="relative text-center">
          {/* Shadow/Blur Effect */}
          <h1 className="absolute inset-0 font-display text-2xl md:text-5xl lg:text-7xl text-white blur-md opacity-50 animate-[fadeIn_0.5s_ease-out_0.5s_forwards] opacity-0 leading-tight">
            Sai Satguru<br />Textile
          </h1>

          <h1 className="relative font-display text-2xl md:text-5xl lg:text-7xl text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/80 tracking-widest uppercase font-semibold leading-tight animate-[fadeIn_0.5s_ease-out_0.5s_forwards] opacity-0 drop-shadow-sm px-4">
            Sai Satguru<br />
  ...
  return (
    <div className={`flex items-center gap-2 md:gap-4 ${className} group`}>
      {/* Icon */}
      <div className="flex-shrink-0 text-white group-hover:text-brand-gold transition-all duration-500">
        <BrandSymbol size="normal" />
      </div>

      {/* Text Container */}
      <div className="flex flex-col">
        <h1 className="font-display text-white tracking-widest uppercase leading-none drop-shadow-sm group-hover:text-brand-gold transition-all duration-300 text-xs md:text-lg lg:text-xl">
          Sai Satguru
        </h1>
        <span className="text-brand-gold uppercase tracking-[0.4em] leading-tight ml-0.5 font-light transition-all duration-300 text-[7px] md:text-[9px] lg:text-[10px] mt-0.5 md:mt-1">
          Textile
        </span>
      </div>
    </div>
